        ...
        <div style={{ display: "flex" }}>
            ...
            <div style={{ width: "100%" }}>
                ...
                <div className="p-4 md:p-8" style={{ width: "100%" }} >
                   <div className='HDdiv'>
                    <div><h1> History Details</h1></div>
                    <div><Link to="/myMembership"><button>Back</button></Link></div>
                   </div>


<div style={{background:"white",padding:"15px",marginTop:"40px",borderRadius:"10px",overflowY:"auto"}}>
    <table  className="table-auto w-full border-collapse">
        <tbody>
            <tr className="bg-gray-100 text-left">
                <td className="p-3 border">Package Name</td>
                ...
                <tr className="bg-gray-100 text-left">
                <td className="p-3 border">Package Price</td>
                ...
                <td className="p-3 border">Payment Status</td>
                   <td className="p-3 border">{order?.payment_status === "1"?"Completed":"Not Compelted"}</td>
                </tr>
               <tr className="bg-gray-100 text-left"><td className="p-3 border">Package Start Date</td>
                  <td className="p-3 border">{order?.purchase_date}</td>
               </tr>
               <tr className="bg-gray-100 text-left"> 
                 <td className="p-3 border">Package End Date</td>
