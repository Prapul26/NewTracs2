...
{}
  ...
  <div className={`min-h-screen flex flex-col ${theme === 'dark' ? 'dark bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-800'} transition-colors duration-300 font-sans`} style={{borderRadius:"20px"}}>
       ...
       <main className="flex-1 flex flex-col min-h-screen overflow-x-hidden transition-all duration-305">
         ...
         <div className="flex items-center gap-1 w-full mt-10 justify-center">
