          ...
          <div className='contentSide'>
            ...
            </div>
            {
              ...
              <div className='introDrop'>
                <Link to="/dashboard"> <div className={`introDrop1 ${currentPath === "/dashboard" || currentPath=== "/newMakeIntro"||currentPath === "/make-Introduction" || currentPath.startsWith("/replyMessage") ? "activeItem" : "" }`}><div style={{ marginTop: "3px", marginRight: "8px" }}><TbMailOpened /></div><span>Introduction Message</span></div></Link>
            ...
            </div>
            {
              ...
              <div className='resDrop'>
                <Link to="/helpGuide"><div className={`resDrop1 ${currentPath === "/helpGuide" ? "activeItem" : "" }`}><div style={{ marginTop: "3px", marginRight: "8px" }}><FaRegPenToSquare /></div><span>App Help</span></div></Link>
